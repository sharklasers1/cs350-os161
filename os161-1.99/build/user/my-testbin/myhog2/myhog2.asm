...
00400050 <main>:
  ...
  40005c:	8ca40000 	lw	a0,0(a1)
  400060:	afb1001c 	sw	s1,28(sp)
  400064:	00a08821 	move	s1,a1
  400068:	afbf0020 	sw	ra,32(sp)
  40006c:	0c100084 	jal	400210 <puts>
  400070:	00108080 	sll	s0,s0,0x2
  400074:	8e240004 	lw	a0,4(s1)
  400078:	0c100084 	jal	400210 <puts>
  40007c:	02118021 	addu	s0,s0,s1
  400080:	8e020000 	lw	v0,0(s0)
  400084:	00000000 	nop
  400088:	1040001a 	beqz	v0,4000f4 <main+0xa4>
  40008c:	00000000 	nop
  400090:	3c040040 	lui	a0,0x40
  400094:	0c10005f 	jal	40017c <printf>
  400098:	24841674 	addiu	a0,a0,5748
  40009c:	afa00010 	sw	zero,16(sp)
  4000a0:	8fa20010 	lw	v0,16(sp)
  4000a4:	3403c34f 	li	v1,0xc34f
  4000a8:	0062102a 	slt	v0,v1,v0
  4000ac:	1440000b 	bnez	v0,4000dc <main+0x8c>
  4000b0:	00000000 	nop
  4000b4:	3404c350 	li	a0,0xc350
  4000b8:	8fa20010 	lw	v0,16(sp)
  4000bc:	00000000 	nop
  4000c0:	24420001 	addiu	v0,v0,1
  4000c4:	afa20010 	sw	v0,16(sp)
  4000c8:	8fa30010 	lw	v1,16(sp)
  4000cc:	00000000 	nop
  4000d0:	0064182a 	slt	v1,v1,a0
  4000d4:	1460fff8 	bnez	v1,4000b8 <main+0x68>
  4000d8:	00000000 	nop
  4000dc:	8fbf0020 	lw	ra,32(sp)
  4000e0:	8fb1001c 	lw	s1,28(sp)
  4000e4:	8fb00018 	lw	s0,24(sp)
  4000e8:	00001021 	move	v0,zero
  4000ec:	03e00008 	jr	ra
  4000f0:	27bd0028 	addiu	sp,sp,40
  4000f4:	3c040040 	lui	a0,0x40
  4000f8:	0c100084 	jal	400210 <puts>
  4000fc:	24841660 	addiu	a0,a0,5728
  400100:	08100027 	j	40009c <main+0x4c>
  400104:	00000000 	nop
	...
